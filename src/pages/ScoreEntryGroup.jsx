...
function ScannerModal({ onClose, onDetected }) {
  const CAMERA_PREF_KEY = "scanner_camera_pref_group";
      ...
      try {
        ...
        if (hasBarcode) {
          ...
          try {
            ...
            const controls = await codeReader.decodeFromVideoDevice(resolvedDeviceId || null, videoRef.current, (result, _err, c) => {
              if (result) {
