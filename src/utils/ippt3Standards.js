...
let _precompiled = null
try {
  // Static import: ensures bundling and avoids path resolution edge cases
  // eslint-disable-next-line import/no-unresolved
  // @ts-ignore
  // Note: this file is generated by scripts/build-ippt3-tables.mjs
  // and should exist at build/runtime for scoring to work.
  // If absent, we will fallback to an empty table to avoid crashes.
  // Vite will tree-shake if unused.
  const tables = await (async () => (await import('../data/ippt3_tables.js')).default)()
  if (tables && typeof tables === 'object') _precompiled = tables
} catch {}
try {
